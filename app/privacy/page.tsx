...
export const metadata = createMetadata({
  title: "Privacy",
  path: "/privacy",
  description: "Think Like Programmer is a privacy-friendly site: no accounts, no unnecessary tracking.",
});
  ...
  return (
    <div className="max-w-2xl">
      ...
      <div className="flex flex-col gap-6 text-fg-muted">
        <section>
          <h2 className="mb-2 text-lg font-semibold text-fg">No account required</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 text-lg font-semibold text-fg">Tracking</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 text-lg font-semibold text-fg">External links</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 text-lg font-semibold text-fg">Hosting</h2>
          <p>
