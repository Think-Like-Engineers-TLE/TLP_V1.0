  ...
  return (
    <div className="max-w-2xl">
      ...
      <div className="flex flex-col gap-6 text-fg-muted">
        <section>
          <h2 className="mb-2 text-lg font-semibold text-fg">Why TLP exists</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 text-lg font-semibold text-fg">How resources are selected</h2>
          <p>
            Every resource must answer one question: <em>why are we legally allowed to list and
            share this?</em> Entries are accepted only when the license or an explicit permission
            allows it — public domain, a Creative Commons or open license, direct author permission,
            or an official free distribution. A PDF existing somewhere is not enough.
          </p>
        </section>
        ...
        <section>
          <h2 className="mb-2 text-lg font-semibold text-fg">Contribute</h2>
          <p>
            See the{" "}
